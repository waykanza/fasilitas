...
$opr1 = (isset($_REQUEST['opr1'])) ? clean_opertaor($_REQUEST['opr1']) : '';
...
$query = "
SELECT 
	COUNT(l.KEY_KSP) AS TOTAL
FROM 
	KWT_TARIF_KSP l
	LEFT JOIN KWT_TIPE_KSP t ON l.KODE_TIPE = t.KODE_TIPE
WHERE
...
<tr>
	...
	<th class="w15">KEY#</th>
	<th class="w44">KATEGORI</th>
	<th class="w18">TARIF</th>
	<th class="w18">SAVE DEPOSIT</th>
</tr>
...
if ($kode_lokasi != '' AND $total_data > 0)
{
	...
	while( ! $obj->EOF)
	{
		...
		<tr class="onclick" id="<?php echo $id; ?>"> 
			...
			<td class="text-right"><?php echo to_money($obj->fields['SAVE_DEPOSIT']); ?></td>
		</tr>
		<?php
		$obj->movenext();
	}
