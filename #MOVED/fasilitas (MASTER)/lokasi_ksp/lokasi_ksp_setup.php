<div class="title_page">LOKASI KEGIATAN SHOOTING / PEMOTRETAN</div>
<div id="msg"></div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master_fa + 'lokasi_ksp/lokasi_ksp_load.php', data);
...
{
	var url =	base_master_fa + 'lokasi_ksp/lokasi_ksp_popup.php' +
				'?act=' + act +
				'&kode_sk=' + jQuery('#kode_sk').val() + 
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' Lokasi Kegiatan Shooting / Pemotretan', url, 500, 330);
