<?php
require_once('kategori_mp_proses.php');
?>
...
<tr>
	...
	<td>
		<input readonly="readonly" type="text" name="kode_mp" id="kode_mp" size="1" class="text-center" value="<?php echo $kode_mp; ?>">
		<input type="text" name="kode_tipe" id="kode_tipe" size="2" value="<?php echo $kode_tipe; ?>">
	</td>
</tr>
<tr>
	<td>KATEGORI</td>
	<td><input type="text" name="nama_tipe" id="nama_tipe" size="40" value="<?php echo $nama_tipe; ?>"></td>
</tr>
<tr>
	<td></td>
	<td class="td-proses">
