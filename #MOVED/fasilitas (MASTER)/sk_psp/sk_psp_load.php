...
if ($search1 != '' || $search2 != '')
{
	...
	if ($search2 != '')
	{
		$query_search .= " $and RIGHT(CONVERT(VARCHAR(10),$field2,105),7) = '$search2' ";
	}
}
...
<tr>
	...
	<th class="w20">NO SK</th>
	<th class="w8">TGL SK</th>
	<th class="w8">TGL BERLAKU</th>
	<th class="w15">PEMBUAT</th>
