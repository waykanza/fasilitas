<div class="title_page">SK TARIF PEMBUKAAN SARANA PRASARANAN LINGKUNGAN</div>
<div id="msg"></div>
...
<tr>
	...
	<td width="100">
		<select name="field1" id="field1">
			...
			<option value="NO_SK"> NO SK </option>
...
<tr>
	<td></td>
	<td>
		<select name="field2" id="field2" class="w100">
			<option value="TGL_SK"> TGL SK </option>
			<option value="TGL_BERLAKU"> TGL BERLAKU </option>
		</select>
	</td>
	<td>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master_fa + 'sk_psp/sk_psp_load.php', data);
...
{
	var url =	base_master_fa + 'sk_psp/sk_psp_popup.php' +
				'?act=' + act +
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' Sk Tarif Pembukaan Sarana Prasaranan Lingkungan', url, 500, 410);
...
function deleteData()
{
	var url		= base_master_fa + 'sk_psp/sk_psp_proses.php',
