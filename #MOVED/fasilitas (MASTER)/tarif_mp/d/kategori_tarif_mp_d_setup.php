<div class="title_page">KATEGORI TARIF MEDIA PROMOSI<br>BANNER / BALIHO</div>
<div id="msg"></div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master_fa + 'tarif_mp/d/kategori_tarif_mp_d_load.php', data);
...
{
	var url =	base_master_fa + 'tarif_mp/d/kategori_tarif_mp_d_popup.php' +
				'?act=' + act +
