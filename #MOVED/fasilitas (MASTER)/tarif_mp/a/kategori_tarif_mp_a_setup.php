<div class="title_page">KATEGORI TARIF MEDIA PROMOSI<br>BILLBOARD / SIGNBOARD / PYLON SIGN</div>
<div id="msg"></div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master_fa + 'tarif_mp/a/kategori_tarif_mp_a_load.php', data);
...
{
	var url =	base_master_fa + 'tarif_mp/a/kategori_tarif_mp_a_popup.php' +
				'?act=' + act +
