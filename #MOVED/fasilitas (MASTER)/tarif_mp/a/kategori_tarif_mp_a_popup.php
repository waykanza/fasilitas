<?php
require_once('kategori_tarif_mp_a_proses.php');
?>
...
$(function() {
	...
	$('#ukuran_1, #ukuran_2').inputmask('numericDecimal', { integerDigits: 3 });
	...
	$(document).on('click', '#save', function(e) {
		e.preventDefault();
		var url		= base_master_fa + 'tarif_mp/a/kategori_tarif_mp_a_proses.php',
			data	= $('#form').serialize();
...
<tr>
	<td>UKURAN</td>
	<td>
		<input type="text" name="ukuran_1" id="ukuran_1" size="6" value="<?php echo $ukuran_1; ?>"> - 
		<input type="text" name="ukuran_2" id="ukuran_2" size="6" value="<?php echo $ukuran_2; ?>"> m&sup2;
	</td>
</tr>
