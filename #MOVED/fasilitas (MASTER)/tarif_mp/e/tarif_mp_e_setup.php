<div class="title_page">TARIF MEDIA PROMOSI<br>BUS TRANS BINTARO JAYA</div>
<div id="msg"></div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master_fa + 'tarif_mp/e/tarif_mp_e_load.php', data);
...
{
	var url =	base_master_fa + 'tarif_mp/e/tarif_mp_e_popup.php' +
				'?act=' + act +
...
function deleteData()
{
	...
	var url		= base_master_fa + 'tarif_mp/e/tarif_mp_e_proses.php',
