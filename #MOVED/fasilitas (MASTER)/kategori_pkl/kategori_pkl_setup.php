<div class="title_page">KATEGORI PEDAGANG KAKI LIMA</div>
<div id="msg"></div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master_fa + 'kategori_pkl/kategori_pkl_load.php', data);
...
{
	var url =	base_master_fa + 'kategori_pkl/kategori_pkl_popup.php' +
				'?act=' + act +
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' Kategori Pedagang Kaki Lima', url, 500, 250);
...
function deleteData()
{
	var url		= base_master_fa + 'kategori_pkl/kategori_pkl_proses.php',
