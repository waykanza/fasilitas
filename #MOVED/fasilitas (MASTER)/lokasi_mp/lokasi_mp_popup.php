<?php
require_once('lokasi_mp_proses.php');
?>
...
<tr>
	...
	<td><input type="text" name="kode_lokasi" id="kode_lokasi" size="2" value="<?php echo $kode_lokasi; ?>"></td>
</tr>
<tr>
	<td>LOKASI</td>
	<td><input type="text" name="nama_lokasi" id="nama_lokasi" size="40" value="<?php echo $nama_lokasi; ?>"></td>
</tr>
<tr>
	<td></td>
	<td class="td-proses">
