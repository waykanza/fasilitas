<div class="title_page">SK TARIF SEWA</div>
<div id="msg"></div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master_fa + 'sk_sewa/sk_sewa_load.php', data);
...
{
	var url =	base_master_fa + 'sk_sewa/sk_sewa_popup.php' +
				'?act=' + act +
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' Sk Tarif Sewa', url, 500, 380);
