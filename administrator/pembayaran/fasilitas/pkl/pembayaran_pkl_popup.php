<?php
require_once('pembayaran_pkl_proses.php');
...
jQuery(function($) {
	...
	$('#save').on('click', function(e) {
		e.preventDefault();
		var 
			url			= base_pembayaran_fasilitas + 'pkl/pembayaran_pkl_proses.php',
			data		= $('#form').serialize();
	...
	$('#batal').on('click', function(e) {
		e.preventDefault();
		var 
			url			= base_pembayaran_fasilitas + 'pkl/batal_pkl_proses.php',
			data		= $('#form').serialize();
	...
	$('#cetak').on('click', function(e) {
		...
		window.open(base_pembayaran_fasilitas + 'pkl/cetak_kwitansi.php?id_pembayaran=' +  $('#id').val(), '1');
...
<table class="smf t-popup wauto f-left" style="margin-right:100px">
	...
	<tr><td>PERIODE KE</td><td>:</td><td><?php echo $periode[0]; ?>-<?php echo $periode[1]; ?></td></tr>
	<input type="hidden" name="periode_thn" value="<?php echo $periode[1]; ?>">
	<input type="hidden" name="periode_bln" value="<?php echo $periode[0]; ?>">
