<div class="title-page">PEMBAYARAN PEDAGANG KAKI LIMA</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_pembayaran_fasilitas + 'pkl/pkl_load.php', data);
...
{
	var url = base_pembayaran_fasilitas + 'pkl/pembayaran_pkl_popup.php?id=' + id;
	setPopup('Pembayaran PKL', url, 800, 600);
