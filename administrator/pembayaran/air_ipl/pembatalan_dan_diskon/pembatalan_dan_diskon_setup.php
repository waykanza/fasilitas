<div class="title-page">PEMBATALAN DAN DISKON<br>AIR & IPL</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_pembayaran + 'air_ipl/pembatalan_dan_diskon/pembatalan_dan_diskon_load.php', data);
...
{
	var url =	base_pembayaran + 'air_ipl/pembatalan_dan_diskon/pembatalan_dan_diskon_popup.php?id=' + id;
