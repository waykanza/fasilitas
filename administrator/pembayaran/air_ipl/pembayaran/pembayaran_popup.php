...
jQuery(function($) {
	...
	$('#save').on('click', function(e) {
		...
		var jenis_bayar	= $('#jenis_bayar').val(),
			url			= base_pembayaran + 'air_ipl/pembayaran/pembayaran_proses.php',
			data		= $('#form').serialize();
	...
	$('#daftar_piutang').on('click', function(e) {
		...
		var url = base_pembayaran + 'air_ipl/pembayaran/daftar_piutang.php?no_pelanggan=<?php echo $no_pelanggan; ?>';
	...
	$('#cetak').on('click', function(e) {
		...
		open_print(base_pembayaran + 'air_ipl/pembayaran/cetak_kwitansi.php?id_pembayaran=' + $('#id').val(), '1');
