<div class="title-page">EDIT METER AIR</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_pembayaran + 'air_ipl/edit_stand_meter/edit_stand_meter_load.php', data);
...
{
	var url =	base_pembayaran + 'air_ipl/edit_stand_meter/edit_stand_meter_popup.php?id=' + id;
	
	setPopup('Edit Meter Air', url, winWidth-70, winHeight-100);
