<div class="title-page">PEMBAYARAN AIR & IPL</div>
...
<tr>
	<td>TOTAL DATA</td>
	<td id="total-data"></td>
	<td width="120" class="text-right"><input type="button" id="pelanggan_baru" value=" Pelanggan Baru "></td>
</tr>
</table>
...
jQuery(function($) {
	...
	$(document).on('click', '#pelanggan_baru', function(e) {
		e.preventDefault();
		var url = base_pembayaran + 'air_ipl/pelanggan_baru/pelanggan_baru_popup.php';
		setPopup('Pelanggan Baru AIR & IPL', url, winWidth-70, winHeight-100);
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_pembayaran + 'air_ipl/pembayaran_load.php', data);
...
{
	var url = base_pembayaran + 'air_ipl/pembayaran_popup.php?id=' + id;
	
	setPopup('Pembayaran AIR & IPL', url, winWidth-70, winHeight-100);
