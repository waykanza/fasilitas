...
jQuery(function($) {
	...
	function do_process() {
		var url			= base_pembayaran + 'deposit/pembayaran_proses.php',
			data		= $('#form').serialize();
	...
	$('#daftar_piutang').on('click', function(e) {
		...
		var url = base_pembayaran + 'deposit/daftar_piutang.php?no_pelanggan=<?php echo $no_pelanggan; ?>';
	...
	$('#cetak_kwitansi').on('click', function(e) {
		...
		open_print(base_pembayaran + 'deposit/cetak_kwitansi.php?tipe=1&idp=' + $('#id').val(), '1');
