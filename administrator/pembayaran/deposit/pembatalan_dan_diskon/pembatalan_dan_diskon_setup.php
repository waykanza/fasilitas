<div class="title-page">PEMBATALAN DAN DISKON<br>SAVE DEPOSIT</div>
...
<tr>
	...
	<td>
		<select name="tipe_load" id="tipe_load" class="wauto">
			<option value="load_periode"> PERIODE </option>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_pembayaran + 'deposit/pembatalan_dan_diskon/pembatalan_dan_diskon_load.php', data);
...
{
	var url =	base_pembayaran + 'deposit/pembatalan_dan_diskon/pembatalan_dan_diskon_popup.php?id=' + id;
	
	setPopup('Pembatalan & Diskon', url, winWidth-70, winHeight-100);
