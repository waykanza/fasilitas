<div class="title-page">LAPORAN REKAP RENCANA PENERIMAAN<br>AIR & IPL</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		...
		location.href = base_laporan + 'air_ipl/rencana_rekap/rencana_rekap_xls.php?' + $('#form').serialize();
		return false;
	});
	...
	$(document).on('click', '#print', function(e) {
		...
		var url = base_laporan + 'air_ipl/rencana_rekap/rencana_rekap_print.php?' + $('#form').serialize();
		open_print(url)
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_laporan + 'air_ipl/rencana_rekap/rencana_rekap_load.php', data);
