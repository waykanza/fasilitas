<div class="title-page">LAPORAN REKAP PENERIMAAN<br>AIR & IPL</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		...
		if (jQuery('#jenis_laporan').val() == 'REKAP_TANGGAL') {
			var file = 'penerimaan_rekap_tanggal_xls.php?';
		} else {
			var file = 'penerimaan_rekap_xls.php?';
		}
		
		location.href = base_laporan + 'air_ipl/penerimaan_rekap/' + file + $('#form').serialize();
		return false;
	});
	...
	$(document).on('click', '#print', function(e) {
		...
		var url = base_laporan + 'air_ipl/penerimaan_rekap/' + file + $('#form').serialize();
		open_print(url)
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_laporan + 'air_ipl/penerimaan_rekap/' + file, data);
