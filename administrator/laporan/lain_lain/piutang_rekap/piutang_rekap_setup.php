<div class="title-page">LAPORAN REKAP PIUTANG<br>BIAYA LAIN-LAIN</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		...
		location.href = base_laporan + 'lain_lain/piutang_rekap/piutang_rekap_xls.php?' + $('#form').serialize();
		return false;
	});
	...
	$(document).on('click', '#print', function(e) {
		...
		var url = base_laporan + 'lain_lain/piutang_rekap/piutang_rekap_print.php?' + $('#form').serialize();
		open_print(url)
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_laporan + 'lain_lain/piutang_rekap/piutang_rekap_load.php', data);
