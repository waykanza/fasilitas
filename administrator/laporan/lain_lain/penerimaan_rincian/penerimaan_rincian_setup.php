<div class="title-page">LAPORAN RINCIAN PENERIMAAN<br>BIAYA LAIN-LAIN</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		...
		location.href = base_laporan + 'lain_lain/penerimaan_rincian/penerimaan_rincian_xls.php?' + $('#form').serialize();
		return false;
	});
	...
	$(document).on('click', '#print', function(e) {
		...
		var url = base_laporan + 'lain_lain/penerimaan_rincian/penerimaan_rincian_print.php?' + $('#form').serialize();
		open_print(url)
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_laporan + 'lain_lain/penerimaan_rincian/penerimaan_rincian_load.php', data);
