<div class="title-page">LAPORAN RINCIAN PIUTANG<br>SAVE DEPOSIT</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		...
		location.href = base_laporan + 'deposit/piutang_rincian/piutang_rincian_xls.php?' + $('#form').serialize();
		return false;
	});
	...
	$(document).on('click', '#print', function(e) {
		...
		var url = base_laporan + 'deposit/piutang_rincian/piutang_rincian_print.php?' + $('#form').serialize();
		open_print(url)
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_laporan + 'deposit/piutang_rincian/piutang_rincian_load.php', data);
