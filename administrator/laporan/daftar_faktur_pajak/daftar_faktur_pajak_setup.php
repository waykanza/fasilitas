<div class="title-page">LAPORAN DAFTAR FAKTUR PAJAK</div>

<form name="form" id="form" method="post">
<table class="t-control wauto">
<tr>
	<td width="120">TGL POSTING</td>
	<td> <input type="text" name="tgl_posting" id="tgl_posting" size="13" class="apply dd-mm-yyyy" value=""></td>
</tr>
...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		e.preventDefault();
		if (jQuery('#tgl_posting').val() == '') {
			alert('Masukkan tanggal posting!');
			jQuery('#tgl_posting').focus();
			return false;
		}
		
		location.href = base_laporan + 'daftar_faktur_pajak/daftar_faktur_pajak_xls.php?' + $('#form').serialize();
		return false;
	});
	...
	$(document).on('click', '#print', function(e) {
		...
		var url = base_laporan + 'daftar_faktur_pajak/daftar_faktur_pajak_print.php?' + $('#form').serialize();
		open_print(url)
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_laporan + 'daftar_faktur_pajak/daftar_faktur_pajak_load.php', data);
