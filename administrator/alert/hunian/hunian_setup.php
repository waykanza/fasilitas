<div class="title-page">INVOICE SAVE DEPOSIT</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#print', function(e) {
		...
		if (checked < 1) {
			...
			open_print(base_alert + 'hunian/hunian_print.php?' + $('#form').serialize());
		}
...
function loadData() {
	...
	jQuery('#t-detail').load(base_alert + 'hunian/hunian_load.php', jQuery('#form').serialize());
