<div class="title-page">EDIT STAND METER</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_periode + 'edit_sm/edit_sm_load.php', data);
...
{
	var url = base_periode + 'edit_sm/edit_sm_popup.php?id=' + id;
	
	setPopup('Edit Stand Meter', url, winWidth-70, winHeight-100);
