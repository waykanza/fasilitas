<?php
require_once('periode_bangun_proses.php');
?>
...
jQuery(function($) {
	...
	$('#save').on('click', function(e) {
		e.preventDefault();
		var url		= base_periode + 'periode_bangun/periode_bangun_proses.php',
			data	= $('#form').serialize();
...
<tr>
	<td>DEPOSIT</td>
	<td><input readonly="readonly" type="text" name="nilai_deposit" id="nilai_deposit" size="20" value="<?php echo $nilai_deposit; ?>"></td>
</tr>
