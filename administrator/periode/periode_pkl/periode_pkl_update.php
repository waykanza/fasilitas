...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	try
	{
		...
		$query = "
		UPDATE PELANGGAN_PKL SET NAMA_PELANGGAN = '$nama_pelanggan', NO_TELEPON = '$no_telepon', ALAMAT = '$alamat', NPWP = '$npwp' WHERE ID_PEMBAYARAN = $id_pembayaran
			
		";

		ex_false($conn->Execute($query), $query);
		$conn->committrans();	
		$msg = 'Data pelanggan pkl berhasil disimpan.';
	}
	catch(Exception $e)
	{
		$msg = $e->getmessage();
