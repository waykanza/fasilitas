<div class="title-page">PERIODE SEWA LAHAN</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#tambah', function(e) {
		e.preventDefault();
		var url = base_periode + 'periode_sl/tambah_periode_sl.php';
		setPopup('Tambah Periode Sewa Lahan', url, 1000, winHeight-100);
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_periode + 'periode_sl/periode_sl_load.php', data);
...
{
	var url = base_periode + 'periode_sl/pelanggan_mp_popup.php?id=' + id;
