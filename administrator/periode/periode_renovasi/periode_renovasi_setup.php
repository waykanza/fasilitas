<div class="title-page">PERIODE RENOVASI</div>
...
<tr>
	<td>STATUS BLOK</td>
	<td>
		<input type="radio" name="status_blok" id="sbmm" value="5" checked="checked"> <label for="sbmm">RENOVASI</label>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_periode + 'periode_renovasi/periode_renovasi_load.php', data);
...
{
	var url =	base_periode + 'periode_renovasi/periode_renovasi_popup.php?id=' + id;
	
	setPopup('Periode Renovasi', url, winWidth-70, winHeight-100);
