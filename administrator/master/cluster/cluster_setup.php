...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master + 'cluster/cluster_load.php', data);
...
{
	var url =	base_master + 'cluster/cluster_popup.php' +
				'?act=' + act +
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' Cluster', url, 500, 300);
...
<div class="title-page ">MASTER CLUSTER</div>
...
<tr>
	...
	<td>
		<select name="field1" id="field1">
			<option value="KODE_CLUSTER"> KODE </option>
			<option value="NAMA_CLUSTER"> NAMA CLUSTER </option>
		</select>
...
<tr>
	<td></td>
	<td>
		<select name="search2" id="search2" class="apply wauto">
