<div class="title-page">LOKASI MEDIA PROMOSI</div>
...
<tr>
	...
	<td>
		<select name="field1" id="field1">
			...
			<option value="NAMA_LOKASI"> LOKASI </option>
		</select>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master_fa + 'lokasi_mp/lokasi_mp_load.php', data);
...
{
	var url =	base_master_fa + 'lokasi_mp/lokasi_mp_popup.php' +
				'?act=' + act +
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' Lokasi Media Promosi', url, 500, 250);
...
function deleteData()
{
	var url		= base_master_fa + 'lokasi_mp/lokasi_mp_proses.php',
