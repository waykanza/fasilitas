<div class="title-page">LOKASI PEDAGANG KAKI LIMA</div>
...
<tr>
	...
	<td>
		<select name="field1" id="field1" class="wauto">
			...
			<option value="DETAIL_LOKASI"> DETAIL LOKASI </option>
		</select>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master_fa + 'lokasi_pkl/lokasi_pkl_load.php', data);
...
{
	var url =	base_master_fa + 'lokasi_pkl/lokasi_pkl_popup.php' +
				'?act=' + act +
				'&kode_sk=' + jQuery('#kode_sk').val() + 
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' Lokasi Pedagang Kaki Lima', url, 500, 330);
