<div class="title-page">KATEGORI PEMBUKAAN SARANA PRASARANAN LINGKUNGAN</div>
...
<tr>
	...
	<td>
		<select>
			<option value="KODE_TIPE"> KATEGORI </option>
		</select>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master_fa + 'kategori_psp/kategori_psp_load.php', data);
...
{
	var url =	base_master_fa + 'kategori_psp/kategori_psp_popup.php' +
				'?act=' + act +
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' Kategori Pembukaan Sarana Prasaranan Lingkungan', url, 500, 240);
