...
if ($search1 != '')
{
	$query_search .= " WHERE KODE_TIPE LIKE '%$search1%' ";
}
...
<table id="pagging-1" class="t-control w52">
<tr>
	<td>
...
<table class="t-data w52">
<tr>
	<th class="w5"><input type="checkbox" id="cb_all"></th>
	<th class="w95">KATEGORI</th>
</tr>
...
<table id="pagging-2" class="t-control w52"></table>
