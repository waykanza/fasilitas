<div class="title-page">DETAIL TARIF MEDIA PROMOSI<br>BANNER / BALIHO</div>
...
jQuery(function($) {
	...
	$('#kode_sk').on('change', function(e) {
		e.preventDefault();
		$('#t-detail').html('');
		$('#key_mp').load(base_master_fa + 'tarif_mp/d/opt_parent.php?kode_sk=' + $(this).val());
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master_fa + 'tarif_mp/d/detail_tarif_mp_d_load.php', data);
...
{
	var url =	base_master_fa + 'tarif_mp/d/detail_tarif_mp_d_popup.php' +
				'?act=' + act +
...
function deleteData()
{
	...
	var url		= base_master_fa + 'tarif_mp/d/detail_tarif_mp_d_proses.php',
