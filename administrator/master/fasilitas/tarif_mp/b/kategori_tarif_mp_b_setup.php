<div class="title-page">KATEGORI TARIF MEDIA PROMOSI<br>NEON BOX / NEON SIGN</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master_fa + 'tarif_mp/b/kategori_tarif_mp_b_load.php', data);
...
{
	var url =	base_master_fa + 'tarif_mp/b/kategori_tarif_mp_b_popup.php' +
				'?act=' + act +
