<div class="title-page">KATEGORI KEGIATAN SHOOTING / PEMOTRETAN</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master_fa + 'kategori_ksp/kategori_ksp_load.php', data);
...
{
	var url =	base_master_fa + 'kategori_ksp/kategori_ksp_popup.php' +
				'?act=' + act +
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' Kategori Kegiatan Shooting / Pemotretan', url, 500, 250);
...
function deleteData()
{
	var url		= base_master_fa + 'kategori_ksp/kategori_ksp_proses.php',
