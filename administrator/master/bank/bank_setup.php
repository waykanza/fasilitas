...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master + 'bank/bank_load.php', data);
...
{
	var url =	base_master + 'bank/bank_popup.php' +
				'?act=' + act +
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' Bank', url, 500, 330);
...
<div class="title-page">MASTER BANK</div>
...
<tr>
	...
	<td>
		<select name="field1" id="field1">
			...
			<option value="NAMA_BANK"> BANK </option>
			<option value="CB_BANK"> CABANG</option>
