...
jQuery(function($) {
	...
	$(document).on('click', 'tr.onclick', function(e) {
		e.preventDefault();
		var kode_blok = $(this).data('kode-blok'),
			luas_kavling = $(this).data('luas-kavling'),
			luas_bangunan = $(this).data('luas-bangunan');
			
		parent.jQuery('#ref_kode_blok').val(kode_blok);
		parent.jQuery('#ref_luas_kavling').val(luas_kavling);
		parent.jQuery('#ref_luas_bangunan').val(luas_bangunan);
		parent.jQuery('.ref_kode_blok').html(kode_blok);
		parent.window.focus();
