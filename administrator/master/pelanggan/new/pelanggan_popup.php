...
jQuery(function($) {
	...
	$('#no_hp').inputmask('varchar', { repeat: '20' });
	...
	$('#save').on('click', function(e) {
		...
		var url		= base_master + 'pelanggan/new/pelanggan_proses.php',
			data	= $('#form').serialize();
