<div class="title-page">RUMAH POMPA</div>
...
<tr>
	...
	<td>
		<select name="field1" id="field1">
			<option value="KODE_ZONA"> KODE </option>
			<option value="NAMA_ZONA"> RUMAH POMPA </option>
		</select>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master + 'pompa/pompa_load.php', data);
...
{
	var url =	base_master + 'pompa/pompa_popup.php' +
				'?act=' + act +
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' Rumah Pompa', url, 500, 250);
