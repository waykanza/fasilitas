...
jQuery(function($) {
	...
	$('#kode_zona').inputmask('varchar', { repeat: '3' });
	$('#nama_zona').inputmask('varchar', { repeat: '30' });
	...
	$('#save').on('click', function(e) {
		e.preventDefault();
		var url		= base_master + 'pompa/pompa_proses.php',
			data	= $('#form').serialize();
...
<tr>
	...
	<td><input type="text" name="kode_zona" id="kode_zona" size="3" value="<?php echo $kode_zona; ?>"></td>
</tr>
<tr>
	<td>RUMAH POMPA</td>
	<td><input type="text" name="nama_zona" id="nama_zona" size="40" value="<?php echo $nama_zona; ?>"></td>
</tr>
<tr>
	<td></td>
	<td class="td-action">
