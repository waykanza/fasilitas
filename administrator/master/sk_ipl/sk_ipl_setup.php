...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master + 'sk_ipl/sk_ipl_load.php', data);
...
{
	var url =	base_master + 'sk_ipl/sk_ipl_popup.php' +
				'?act=' + act +
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' Sk Tarif IPL', url, 550, 400);
...
function deleteData()
{
	var url		= base_master + 'sk_ipl/sk_ipl_proses.php',
...
<div class="title-page">MASTER SK TARIF IPL</div>
