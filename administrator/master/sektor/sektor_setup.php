...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master + 'sektor/sektor_load.php', data);
...
{
	var url =	base_master + 'sektor/sektor_popup.php' +
				'?act=' + act +
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' Sektor', url, 500, 280);
...
<div class="title-page">MASTER SEKTOR</div>
...
<tr>
	...
	<td>
		<select name="field1" id="field1">
			<option value="KODE_SEKTOR"> KODE </option>
			<option value="NAMA_SEKTOR"> NAMA SEKTOR </option>
		</select>
