<?php
require_once('sk_air_proses.php');
?>
...
jQuery(function($) {
	...
	$('#no_sk').inputmask('varchar', { repeat: '30' });
	$('#pembuat').inputmask('varchar', { repeat: '30' });
...
<tr>
	<td>KETERANGAN</td>
	<td><textarea name="keterangan" id="keterangan" rows="5" cols="55"><?php echo $keterangan; ?></textarea></td>
</tr>
<tr>
	<td></td>
	<td class="td-action">
