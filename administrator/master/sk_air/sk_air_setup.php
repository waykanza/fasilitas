...
function loadData()
{
	...
	jQuery('#t-detail').load(base_master + 'sk_air/sk_air_load.php', data);
...
{
	var url =	base_master + 'sk_air/sk_air_popup.php' +
				'?act=' + act +
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' Sk Tarif Air', url, 550, 400);
...
function deleteData()
{
	var url		= base_master + 'sk_air/sk_air_proses.php',
...
<div class="title-page">MASTER SK TARIF AIR</div>
