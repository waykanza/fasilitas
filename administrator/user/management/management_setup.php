...
function loadData()
{
	...
	jQuery('#t-detail').load(base_user + 'management/management_load.php', data);
...
{
	var url =	base_user + 'management/management_popup.php' +
				'?act=' + act +
				'&id=' + id,
		title	= (act == 'Simpan') ? 'Tambah' : act;
	
	setPopup(title + ' User', url, winWidth-70, winHeight-100);
...
<div class="title-page">MANAJEMEN USER</div>
...
<tr>
	...
	<td>
		<select name="field1" id="field1">
			<option value="LOGIN_USER"> ID </option>
