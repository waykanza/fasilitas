<div class="title-page">INVOICE MEDIA PROMOSI</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#print', function(e) {
		...
		{
			open_print(base_invoice + 'invois_mp/invoice_proses.php?' + $('#form').serialize());
		}
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_invoice + 'invois_mp/invoice_load.php', jQuery('#form').serialize());
