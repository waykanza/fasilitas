		...
		<div class="text-center" style="margin:0 0 10px 0;">No. : <?php echo $no_invoice; ?></div>
		...
		<tr><td>Tanggal Jatuh Tempo</td><td> : </td><td><?php echo fm_date($tgl_jatuh_tempo); ?></td></tr>
		</table>
		...
		<tr>
			<td colspan="4"><table class="bd-none">
				...
				<tr>
					...
					<td>
						<b>06. Transfer BCA</b><br>
						- 6800636637 a/n PT. Jaya Real Property, Tbk<br>
						- Bukti transfer mohon dikirim sebelum tanggal 28 setiap bulannya
					</td>
				</tr>
			</table></td>
		</tr>
		<tr>
			<td colspan="4"><b>* Info lebih lanjut dapat menghubungi CS kami telp. 021-7486 4001 ext. 201/ 100. fax. 021-7485 4002</b></td>
		</tr>
		</table>
			...
			<ol>
				...
				<li>
					<b>
						...
						<?php echo $denda_persen . '% (' . $terbilang->eja($denda_persen) . ' persen) dari total tagihan air.'; ?>
					</b>
				</li>
