<div class="title-page">INVOICE DEPOSIT</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#print', function(e) {
		...
		{
			open_print(base_invoice + 'deposit/invoice_proses.php?' + $('#form').serialize());
		}
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_invoice + 'deposit/invoice_load.php', jQuery('#form').serialize());
